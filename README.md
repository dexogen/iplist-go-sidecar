...
С 22 сентября 2026 года каталог `config/` удален и из текущего дерева, и из истории Git. После этой миграции старые рабочие копии следует клонировать заново; старые ветки не нужно сливать обратно. История сборщика и пользовательских конфигов сохранена. Публикации данных доступны независимо от истории Git через релиз `data`.
